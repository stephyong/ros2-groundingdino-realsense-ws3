...
#include "groundingdino_interfaces/msg/detail/object_position__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // camera_point, camera_xy_max, camera_xy_min
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // pose
#include "rosidl_runtime_c/string.h"  // class_label
#include "rosidl_runtime_c/string_functions.h"  // class_label
...
using _ObjectPosition__ros_msg_type = groundingdino_interfaces__msg__ObjectPosition;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->class_label;
  ...
  // Field name: camera_xy_min
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->camera_xy_min, cdr))
    {
      return false;
    }
  }

  // Field name: camera_xy_max
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: class_label
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->class_label.data) {
      rosidl_runtime_c__String__init(&ros_message->class_label);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->class_label,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'class_label'\n");
      return false;
    }
  }
...
static uint32_t _ObjectPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_groundingdino_interfaces__msg__ObjectPosition(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = groundingdino_interfaces__msg__ObjectPosition;
    is_plain =
      (
...
static size_t _ObjectPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_groundingdino_interfaces__msg__ObjectPosition(
