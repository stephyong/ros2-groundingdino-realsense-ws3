...
static const _ObjectPosition_type_support_symbol_names_t _ObjectPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, groundingdino_interfaces, msg, ObjectPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, groundingdino_interfaces, msg, ObjectPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, groundingdino_interfaces, msg, ObjectPosition)() {
  return &::groundingdino_interfaces::msg::rosidl_typesupport_c::ObjectPosition_message_type_support_handle;
}
