...
def launch_setup():
    ...
    groundingdino_client_pkg = FindPackageShare('groundingdino_client').find('groundingdino_client')
    ...
    right_camera_calibration_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(groundingdino_client_pkg, 'launch', 'groundingdino_svccli.launch.py')
        )
    )
    ...
    return [
            ...
            groundingdino_svccli.launch.py
    ]
